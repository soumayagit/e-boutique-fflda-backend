...
var JwtAuthGuard = function () {
    ...
    var JwtAuthGuard = _classThis = /** @class */ (function (_super) {
        ...
        JwtAuthGuard_1.prototype.handleRequest = function (err, user, info) {
            var _a;
            if (err || !user) {
                throw err !== null && err !== void 0 ? err : new common_1.UnauthorizedException((_a = info === null || info === void 0 ? void 0 : info.message) !== null && _a !== void 0 ? _a : 'Token invalide ou expiré');
            }
            return user;
        };
