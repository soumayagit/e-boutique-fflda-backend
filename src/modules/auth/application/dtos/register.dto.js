...
var RegisterDto = function () {
    ...
    return _a = /** @class */ (function () {
        ...
        (function () {
            ...
            _email_decorators = [(0, swagger_1.ApiProperty)({ example: 'jean.dupont@email.com' }), (0, class_validator_1.IsEmail)({}, { message: 'Email invalide' })];
            _phone_decorators = [(0, swagger_1.ApiProperty)({ example: '+33612345678', required: false }), (0, class_validator_1.IsString)()];
            _password_decorators = [(0, swagger_1.ApiProperty)({
                ...
                }), (0, class_validator_1.IsString)(), (0, class_validator_1.MinLength)(8, { message: 'Minimum 8 caractères' }), (0, class_validator_1.Matches)(/(?=.*[A-Z])/, { message: 'Au moins une majuscule' }), (0, class_validator_1.Matches)(/(?=.*[a-z])/, { message: 'Au moins une minuscule' }), (0, class_validator_1.Matches)(/(?=.*[0-9])/, { message: 'Au moins un chiffre' }), (0, class_validator_1.Matches)(/(?=.*[!@#$%^&*(),.?":{}|<>])/, {
