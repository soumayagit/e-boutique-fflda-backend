...
export class InvoiceService {
  private readonly COMPANY_NAME = 'E-Boutique FFLDA';
  private readonly COMPANY_ADDRESS = 'France Fédération de Lutte et Disciplines Associées';

  constructor(private readonly prisma: PrismaService) {}

  // ── Récupère ou crée le numéro de facture pour une commande ──
  async getOrCreateInvoiceNumber(orderId: string, totalTTC: number, createdBy?: string): Promise<string> {
  ...
  async generateInvoicePdf(order: any, invoiceNumber: string): Promise<Buffer> {
