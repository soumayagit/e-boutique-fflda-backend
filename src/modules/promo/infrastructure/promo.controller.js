...
var PromoController = function () {
    var _classDecorators = [(0, swagger_1.ApiTags)('Promotions'), (0, swagger_1.ApiBearerAuth)(), (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard), (0, common_1.Controller)('promo')];
    ...
    var PromoController = _classThis = /** @class */ (function () {
        function PromoController_1(promoService) {
            this.promoService = (__runInitializers(this, _instanceExtraInitializers), promoService);
        }
        PromoController_1.prototype.create = function (dto) {
            return this.promoService.createPromo(dto);
        };
        PromoController_1.prototype.findAll = function () {
            return this.promoService.getAllPromos();
        };
        PromoController_1.prototype.toggle = function (id) {
            return this.promoService.togglePromo(id);
        };
        PromoController_1.prototype.remove = function (id) {
            return this.promoService.deletePromo(id);
        };
        PromoController_1.prototype.apply = function (dto) {
    ...
    (function () {
        ...
        _toggle_decorators = [(0, common_1.Patch)(':id/toggle')];
        _remove_decorators = [(0, common_1.Delete)(':id')];
        _apply_decorators = [(0, common_1.Post)('apply')];
