...
var StripeService = function () {
    ...
    var StripeService = _classThis = /** @class */ (function () {
        ...
        StripeService_1.prototype.createPaymentIntent = function (amount, currency, orderId) {
        ...
        StripeService_1.prototype.constructWebhookEvent = function (payload, signature) {
            return this.stripe.webhooks.constructEvent(payload, signature, this.configService.get('STRIPE_WEBHOOK_SECRET'));
        };
        StripeService_1.prototype.createCheckoutSession = function (amount_1, orderId_1) {
            return __awaiter(this, arguments, void 0, function (amount, orderId, currency) {
                var frontendUrl, session;
                var _a;
                if (currency === void 0) { currency = 'eur'; }
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            frontendUrl = (_a = this.configService.get('FRONTEND_URL')) !== null && _a !== void 0 ? _a : 'http://localhost:60888';
                            return [4 /*yield*/, this.stripe.checkout.sessions.create({
                                    ...
                                    line_items: [
                                        {
                                            price_data: {
                                                currency: currency,
                                                product_data: {
                                                    name: "Commande FFLDA #".concat(orderId),
                                                },
                                    ...
                                    mode: 'payment',
                                    success_url: "".concat(frontendUrl, "/#/payment-success"),
                                    cancel_url: "".concat(frontendUrl, "/#/payment-cancel"),
                                    metadata: { orderId: orderId },
                                })];
                        case 1:
                            session = _b.sent();
