...
var ReviewsService = function () {
    ...
    var ReviewsService = _classThis = /** @class */ (function () {
        ...
        ReviewsService_1.prototype.findByProduct = function (productId) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 2:
                            reviews = _a.sent();
                            return [2 /*return*/, reviews.map(function (review) { return ({
                                    id: review.id,
                                    rating: review.rating,
                                    comment: review.comment,
                                    date: review.createdAt,
                                    userName: "".concat(review.user.firstName, " ").concat(review.user.lastName).trim(),
                                }); })];
                    }
                });
            });
        ...
        ReviewsService_1.prototype.create = function (productId, userId, dto) {
            return __awaiter(this, void 0, void 0, function () {
                var product, review;
                var _a;
                        ...
                        case 1:
                            ...
                            return [4 /*yield*/, this.prisma.review.create({
                                    data: {
                                        ...
                                        userId: userId,
                                        rating: dto.rating,
                                        comment: (_a = dto.comment) !== null && _a !== void 0 ? _a : '',
                                    },
                                    include: {
                                        user: {
                                            select: { firstName: true, lastName: true },
        ...
        ReviewsService_1.prototype.getStats = function (productId) {
            return __awaiter(this, void 0, void 0, function () {
                var result;
                var _a, _b;
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        ...
                        case 1:
                            result = _c.sent();
                            return [2 /*return*/, {
                                    averageRating: (_a = result._avg.rating) !== null && _a !== void 0 ? _a : 0,
                                    reviewCount: (_b = result._count.id) !== null && _b !== void 0 ? _b : 0,
                                }];
                    }
                });
            });
