...
var public_decorator_1 = require("../../auth/infrastructure/decorators/public.decorator"); // adapte chemin/nom
var ReviewsController = function () {
    var _classDecorators = [(0, common_1.Controller)('products/:productId/reviews')];
    ...
    var ReviewsController = _classThis = /** @class */ (function () {
        ...
        ReviewsController_1.prototype.findAll = function (productId) {
            return this.reviewsService.findByProduct(productId);
        };
        // GET /products/:productId/reviews/stats
        ReviewsController_1.prototype.getStats = function (productId) {
            return this.reviewsService.getStats(productId);
        };
        // POST /products/:productId/reviews  (authentification requise)
        ReviewsController_1.prototype.create = function (productId, dto, req) {
            var _a;
            var userId = (_a = req.user.id) !== null && _a !== void 0 ? _a : req.user.sub;
    ...
    (function () {
        ...
        _getStats_decorators = [(0, public_decorator_1.Public)(), (0, common_1.Get)('stats')];
