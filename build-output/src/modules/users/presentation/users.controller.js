...
const update_profile_dto_1 = require("../application/dtos/update-profile.dto");
const update_password_dto_1 = require("../application/dtos/update-password.dto");
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Voir mon profil' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Modifier mes informations' }),
    __param(0, (0, current_user_decorator_1.CurrentUser)()),
